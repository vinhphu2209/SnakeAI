...
class PLAYER:
	def __init__(self):
		...
		# Red snake graphics
		self.head_up_red = pygame.image.load('assets/graphics/head_up_red.png').convert_alpha()
		self.head_down_red = pygame.image.load('assets/graphics/head_down_red.png').convert_alpha()
		self.head_right_red = pygame.image.load('assets/graphics/head_right_red.png').convert_alpha()
		self.head_left_red = pygame.image.load('assets/graphics/head_left_red.png').convert_alpha()
		
		self.tail_up_red = pygame.image.load('assets/graphics/tail_up_red.png').convert_alpha()
		self.tail_down_red = pygame.image.load('assets/graphics/tail_down_red.png').convert_alpha()
		self.tail_right_red = pygame.image.load('assets/graphics/tail_right_red.png').convert_alpha()
		self.tail_left_red = pygame.image.load('assets/graphics/tail_left_red.png').convert_alpha()
		
		self.body_vertical_red = pygame.image.load('assets/graphics/body_vertical_red.png').convert_alpha()
		self.body_horizontal_red = pygame.image.load('assets/graphics/body_horizontal_red.png').convert_alpha()
		
		self.body_tr_red = pygame.image.load('assets/graphics/body_tr_red.png').convert_alpha()
		self.body_tl_red = pygame.image.load('assets/graphics/body_tl_red.png').convert_alpha()
		self.body_br_red = pygame.image.load('assets/graphics/body_br_red.png').convert_alpha()
		self.body_bl_red = pygame.image.load('assets/graphics/body_bl_red.png').convert_alpha()
...
class SNAKE:
	...
	def move_snake(self, fruit_pos, player_body):
...
class MAIN:
	...
	def update(self):
		self.snake.move_snake(self.fruit.pos, self.player.body)
